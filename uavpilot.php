...
<!-- Mirrored from thewebmax.com/dronza/about-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Apr 2022 08:30:03 GMT -->
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://hawkaerospace.in/assets/img/img/icons/Hawk1.png" />
    
    <!-- PAGE TITLE HERE -->
    <title>hawkaeropace | UAV Pilot </title>
    ...
    <!-- link uavpilot card  -->
    <link rel="stylesheet" href="css/uavpage/uavpage.css">
...
<body>
    ...
    <!-- header end  -->
        ...
        <div class="page-content">
                    ...
                    <div class="wt-bnr-inr-entry">
                    	<div class="banner-title-outer">
                        	<div class="banner-title-name">
                        		<h2 class="site-text-white">UAV Pilot</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->                            
            ...
            <!-- newslette section  -->
                <div class="newsletter">
                    <div class="inner-newsletter">
                        <h3>UNDERSTANDING UAV'S</h3>
                        <h4>An Unmanned Aerial Vehicle (UAV) is an aircraft with no pilot on board. An alternative term is Unmanned Aerial System (UAS). In the public eye, they are called drones. UAVs are operated remotely by a pilot at a ground control station or they operate autonomously steered by a pre-programmed flight plan.
                            <br><br>
                            The history of these systems is partly in radio-controlled aircraft and partly in military purposes, i.e., to fly over enemy or otherwise dangerous territory. In recent years, however, UAVs have found use in a wide range of civil applications, ranging from urban planning, to monitoring in environmental, agriculture and commercial applications.
                        </h4>
                        <a class="btn-newsletter btn">know more</a>
                    </div>
                </div>
            <!-- newslette section  -->
                            ...
                            <div class="row justify-content-center d-flex">
                                ...
                                <div class="col-lg-6 col-md-12 m-b30">
                                    <div class="about-drone-one">
                                        <div class="about-drone-one-media"><img src="images/about-drone/Untitled-1.png" alt=""  class="slide-top"></div>
                                        <!-- <div class="about-drone-one-info"><span class="outline-title">HD 4K</span><strong>Resolution!</strong></div> -->
                                    </div>
                                </div>  
                                ...
                                <div class="col-lg-6 col-md-12 m-b30">
                                    ...
                                    <div class="left wt-small-separator-outer">
                                        ...
                                        <h2>UAV is really the future!</h2>
                                        <p>Start a game-changing career working with dynamic drone technology. From a military innovation, to an exciting hobby, to a technology that’s transforming commercial industries, the use of drones has rapidly changed over the past years — and future opportunities in the field are limitless.
                                        </p>
                                    ...
                                    <a href="about-1.html" class="site-button site-btn-effect">Contact Us</a> 
                                    </div>                                                                
                                </div>
            ...
            <!-- video section with content start  -->
            <div class="videosection">
                ...
                <div class="content">
                    ...
                    <p>All the pilots trained by Hawk get fixed jobs to fly drone missions with the companies we have partnership with. The companies are into real estate, e-commerce, surveillance, mapping, construction and more. These companies are brands from their industry and also the first-movers in using drone technology for their businesses. Sign up for details.</p>
            ...
            <div class="uavcard">
                <div class="heading-uavcard">
                    <h1>How It Works</h1>
                </div>
                <div class="inner-card">
                    <div class="card-1 cardsuav">
                        <div class="images">
                            <img src="./images/about-drone/Untitled-1.png" alt="">
                        </div>
                        <div class="card-content">
                            <h2>1</h2>
                            <p>Enroll for our programs & learn via theory and practical training with drones.</p>
                        </div>
                    </div>
                    <div class="card-1 cardsuav">
                        <div class="images">
                        ...
                        <div class="card-content">
                            <h2>2</h2>
                            <p>Complete the course and acquire the license to fly.</p>
                        </div>
                    </div>
                    <div class="card-1 cardsuav">
                        <div class="images">
                        ...
                        <div class="card-content">
                            <h2>3</h2>
                            <p>Get the job in your city and start earning.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <!-- timeline section what you will learn  -->
            <div class="timeline">
                <div class="heading-time">
                    <h1>With Our Drone Training, You Will Learn...</h1>
                </div>
                <div class="container-time">
                    <div class="single-box">
                        ...
                        <div class="content">
                            <h2>How to fly different models of drones.</h2>
                        </div>
                    </div>
                    <div class="single-box box-right">
                        ...
                        <div class="content">
                            <h2>How to fly for commercial and public safety use: Wind Turbine Inspection, Solar Farm Inspection, Construction Site Survey, Coast Watch, Fire Scenarios, etc.</h2>
                    ...
                    <div class="single-box">
                        ...
                        <div class="content">
                            <h2>How to fly with real life physics and scenarios.</h2>
                        </div>
                    </div>
                    <div class="single-box box-right">
                        <div class="custom"></div>
                        ...
                        <div class="content">
                            <h2>How to become a better pilot at any level, from beginner to professional.</h2>
                        </div>
                    </div>
                    <div class="single-box ">
                        <div class="custom"></div>
                        ...
                        <div class="content">
                            <h2> How to operate drones as if you’re performing real jobs.</h2>
                        </div>
                    </div>
                    <div class="single-box box-right">
                        <div class="custom"></div>
                        ...
                        <div class="content">
                            <h2>  How to respond in emergency situations so you can have peace of mind on your projects.</h2>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-lg-4 col-md-12 m-b30">
                                    <div class="corner-line">                                    
                                        <div class="wt-box d-icon-box-one bg-white shadow ">
                                            ...
                                            <div class="d-icon-box-title title-style-2 site-text-secondry">
                                                <h3  class="s-title-one">How To Play Video</h3>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-12 m-b30">
                                    <div class="corner-line">                                    
                                        <div class="wt-box d-icon-box-one bg-white shadow ">
                                            ...
                                            <div class="d-icon-box-title title-style-2 site-text-secondry">
                                                <h3  class="s-title-one">How To Use Controler</h3>
                                            </div>
                                        ...
                                        <div class="item">
                                            <div class="video-gallery-block">
                                                ...
                                                <div class="video-media-info">
                                                     <a href="https://www.youtube.com/watch?v=c1XNqw2gSbU" class="mfp-video site-bg-primary">
            ...
            <!-- <div class="footer-middle">
                    ...
                    <div class="footer-middle-content">
                        <div class="logo-footer">
                            <a href="index.html">  <img src="https://hawkaerospace.in/assets/img/img/icons/Hawk1.png" alt=""  height="70px" width="70px"/>
                            </a>                        </div>
            ...
            <div class="footer-bottom">
              <div class="container">
                <div class="wt-footer-bot-left d-flex justify-content-center">
                    <span class="copyrights-text">© 2022 Your Company. Designed By <span class="site-text-primary">Diced</span></span>
                </div>
              </div>   
            </div>   
...
<!-- Mirrored from thewebmax.com/dronza/about-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Apr 2022 08:30:05 GMT -->
</html>
