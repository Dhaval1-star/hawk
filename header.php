                                   ...
                                   <div class="container clearfix"> 
                                        ...
                                        <div class="logo-header">
                                            <div class="logo-header-inner logo-header-one">
                                                <a href="index.php">
                                                <img src="https://hawkaerospace.in/assets/img/img/icons/Hawk1.png" alt=""  height="70px" width="70px"/>
                                                </a>
                                            </div>
                                        </div>  
                                            ...
                                            <ul class=" nav navbar-nav">
                                                ...
                                                <li><a href="javascript:;">About</a>
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a href="./uavpilot.php">UAV Pilot </a></li>                                        
                                                        <li><a href="./aircraftpilot.php">Aircraft Pilot </a></li>                                        
                                                ...
                                                <li><a href="javascript:;">Gallery</a>
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a href="gallery-detail.html">Gallery Detail</a> -->
                                                    </ul>                                
                                               </li>
                                                <li>
