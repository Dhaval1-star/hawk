...
<!-- Mirrored from thewebmax.com/dronza/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Apr 2022 08:29:45 GMT -->
<head>
    ...
    <!-- PAGE TITLE HERE -->
    <title>Hawkaerospace | Home Page Style 1</title>
        ...
        <div class="page-content">
           ...
           <!-- SLIDER START --> 
                    ...
                    <div id="webmax-one" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.1">
                        <ul>	
                            ...
                            data-description="">
								...
								<img src="images/main-slider/slider1/slide1.jpg"  alt=""  data-lazyload="images/main-slider/slider1/slide1.jpg" data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Power1.easeOut" data-scalestart="110" data-scaleend="100" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg xyz" data-no-retina>
                                ...
                                <div class="tp-caption   tp-resizeme home-1-change-img-slide1 " 
                                    ...
                                    <div class="rs-wave"  data-speed="10" data-angle="0" data-radius="50px">
                                      <img 
                                      	  src="images/main-slider/slider1/drone/d-1.png"
                                          alt="" 
                                ...
                                font-weight: 700;
                                color:#fff;
                                border-width:0px; font-family: 'Rajdhani', sans-serif;"><div class="slider-block-black">Ultraportable Drone for the best Video</div></div>
                                ...
                                <div class="tp-caption tp-resizeme rev-btn white" 	
                                ...
                                style="z-index:9;">
                                     <div class="mfp-video rev-slider-play">
                                        <span class="ripple-cirlcle"></span>
                                    </div>   
                                </div> 
                            ...
                            data-description="">
                                ...
                                <div class="tp-caption   tp-resizeme " 
                                    ...
                                    <div class="rs-wave"  data-speed="10" data-angle="0" data-radius="50px">
                                      <img 
                                      	  src="images/main-slider/slider1/drone/d-2.png"
                                          alt="" 
                                ...
                                font-weight: 700;
                                color:#fff;
                                border-width:0px; font-family: 'Rajdhani', sans-serif;"><div class="slider-block-red">Gives you the Visible Difference</div></div>
            ...
            <div class="section-full welcome-section-outer">
            	<div class="how-it-work-section-one bg-white p-tb80">
                    <div class="container">
                            ...
                            <div class="row justify-content-center d-flex">
                                ...
                                <div class="col-lg-8 col-md-12 m-b30 how-it-drone-outer">
                                    <div class="how-it-drone">
                                        <div class="how-it-drone-media"><img src="images/how-it-work/drone-1.png" alt="" class="wave-effects"></div>
                                       
                                        <div class="how-it-drone-info"><span>We Deliver First Class Videos & Photos</span></div>
                                    </div>
                                </div>  
                                    ...
                                    <div class="wt-box d-icon-box-one bg-white shadow card1">
                                        ...
                                        <div class="wt-icon-box-wraper m-b40">
                                            <div class="icon-xl inline-icon">
                                                <span class="icon-cell site-text-primary"><i class="flaticon-drone-6"></i></span>
                                            </div>
                                        </div> 
                                ...
                                <div class="col-lg-4 col-md-6 m-b30">
                                    <div class="wt-box d-icon-box-one bg-white shadow card1">
                                        ...
                                        <div class="wt-icon-box-wraper m-b40">
                                            <div class="icon-xl inline-icon">
                                                <span class="icon-cell site-text-primary"><i class="flaticon-power-supply"></i></span>
                                            </div>
                                        </div> 
                                ...
                                <div class="col-lg-4 col-md-6 m-b30">
                                    <div class="wt-box d-icon-box-one bg-white shadow card1">
                                        ...
                                        <div class="wt-icon-box-wraper m-b40">
                                            <div class="icon-xl inline-icon">
                                                <span class="icon-cell site-text-primary"><i class="flaticon-drone-2"></i></span>
                                            </div>
                                        </div> 
                                ...
                                <div class="col-lg-4 col-md-6 m-b30">
                                    <div class="wt-box d-icon-box-one bg-white shadow card1">
                                        ...
                                        <div class="wt-icon-box-wraper m-b40">
                                            <div class="icon-xl inline-icon">
                                                <span class="icon-cell site-text-primary"><i class="flaticon-remote-control"></i></span>
                                            </div>
                                        </div> 
            ...
            <div class="section-full overlay-wraper products-section p-t80 p-b50 bg-white bg-cover bg-no-repeat" style="background-image:url(images/background/bg-9.jpg);">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-lg-3 col-md-6 m-b30 ">
                                        <div class="counter-box">
                                            ...
                                            <span class="site-text-secondry title-style-2">Satisfied Clients</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 m-b30">
                                        <div class="counter-box">
                                            ...
                                            <span class="site-text-secondry title-style-2">4K Resolution</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 m-b30">
                                        <div class="counter-box">
                                            ...
                                            <span class="site-text-secondry title-style-2">Flight Time</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 m-b30">
                                        <div class="counter-box">
                                            ...
                                            <span class="site-text-secondry title-style-2">Project done</span>
                                        </div>
                                    </div>                                    
                                ...
                                <div class="blog-post date-style-2">
                                    ...
                                    <div class="wt-post-info bg-white">
                                        ...
                                        <div class="wt-post-title ">
                                            <h3 class="post-title">How Drones Are Saving Our Beaches...</h3>
                                        </div>
                                        <div class="wt-post-text ">
                                            <p>suffered alteration in some form, by injected humour, or randomised which don't look even slightly.</p>
                                        </div>                                           
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="blog-post date-style-2">
                                    ...
                                    <div class="wt-post-info bg-white">
                                        ...
                                        <div class="wt-post-title ">
                                            <h3 class="post-title">How to Start a Drone Photography Business...</h3>
                                        </div>
                                        <div class="wt-post-text ">
                                            <p>suffered alteration in some form, by injected humour, or randomised which don't look even slightly.</p>
                                        </div>                                           
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="blog-post date-style-2">
                                    ...
                                    <div class="wt-post-info bg-white">
                                        ...
                                        <div class="wt-post-title ">
                                            <h3 class="post-title">How Amazon is Integrating Drones into Their Supply...</h3>
                                        </div>
                                        <div class="wt-post-text ">
                                            <p>suffered alteration in some form, by injected humour, or randomised which don't look even slightly.</p>
                                        </div>                                        
...
<!-- Mirrored from thewebmax.com/dronza/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Apr 2022 08:29:50 GMT -->
</html>
